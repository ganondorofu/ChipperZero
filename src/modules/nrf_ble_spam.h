...
class NrfBleSpamModule : public IModule {
public:
    bool init() override;
    bool isAvailable() override;
    void start() override;
    void stop() override;
    const char* name() override { return "NRF BLE Spam"; }
...
private:
    ...
    std::atomic<uint8_t>  type_{0};   // NrfBleSpamType::ALL
    std::atomic<uint32_t> adv_per_sec_{0};
    TaskHandle_t          task_ = nullptr;
};

extern NrfBleSpamModule g_nrfBleSpam;
