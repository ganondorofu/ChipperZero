...
constexpr int PIN_NRF_CSN   = 27;  // moved off GPIO22 to free I2C SCL
...
// --- Buttons. GPIO14/16/17 support INPUT_PULLUP; no external resistors needed. ---
constexpr int PIN_BTN_OK    = 14;
constexpr int PIN_BTN_BACK  = 16;
constexpr int PIN_BTN_EXTRA = 17;
